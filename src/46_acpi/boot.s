...
.10L:
	...
	;---------------------------------------
	; Find file name from direcotry entry
	;---------------------------------------
	cdecl	fat_find_file
	cmp	ax,	0
	je	.12E
...
.real:	mov	ax,	0x0000
	...
	;---------------------------------------
	; Intterupt mask settings (for real mode)
	;---------------------------------------
	outp	0x20,	0x11
	outp	0x21,	0x08
	outp	0x21,	0x04
	...
	;---------------------------------------
	; Intterupt mask settings (for protect mode)
	;---------------------------------------
	cli
...
; Padding
;**********************************************
	times	BOOT_SIZE - ($ - $$) - 16	db	0	; 8K byte
	dd	TO_REAL_MODE
